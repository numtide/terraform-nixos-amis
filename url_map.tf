...
variable "url_map" {
  ...
  default = {
    ...
    "latest.ap-east-1.hvm-ebs" = "ami-0835a3e481dc240f9"
    "latest.ap-northeast-1.hvm-ebs" = "ami-07c95eda953bf5435"
    "latest.ap-northeast-2.hvm-ebs" = "ami-04167df3cd952b3bd"
    "latest.ap-south-1.hvm-ebs" = "ami-0680e05531b3db677"
    "latest.ap-southeast-1.hvm-ebs" = "ami-0dc8d718279d3402d"
    "latest.ap-southeast-2.hvm-ebs" = "ami-0155e842329970187"
    "latest.ca-central-1.hvm-ebs" = "ami-0e67089f898e74443"
    "latest.eu-central-1.hvm-ebs" = "ami-0fcf28c07e86142c5"
    "latest.eu-north-1.hvm-ebs" = "ami-0ee83a3c6590fd6b1"
    "latest.eu-west-1.hvm-ebs" = "ami-01d0304a712f2f3f0"
    "latest.eu-west-2.hvm-ebs" = "ami-00e828bfc1e5d09ac"
    "latest.eu-west-3.hvm-ebs" = "ami-0e1ea64430d8103f2"
    "latest.sa-east-1.hvm-ebs" = "ami-0f7c354c421348e51"
    "latest.us-east-1.hvm-ebs" = "ami-099756bfda4540da0"
    "latest.us-east-2.hvm-ebs" = "ami-0b20a80b82052d23f"
    "latest.us-west-1.hvm-ebs" = "ami-088ea590004b01752"
    "latest.us-west-2.hvm-ebs" = "ami-0025b9d4831b911a7"
  }
